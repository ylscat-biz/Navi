...
//        }
        ...
        atOnce |= !mScrollChecker.tryToScrollTo(mPtrIndicator.getOffsetToRefresh(), isHeader ? mDurationToCloseHeader : mDurationToCloseFooter);
        if (atOnce) {
            mStatus = PTR_STATUS_LOADING;
            performRefresh();
        }
    ...
    class ScrollChecker implements Runnable {
        ...
        public boolean tryToScrollTo(int to, int duration) {
